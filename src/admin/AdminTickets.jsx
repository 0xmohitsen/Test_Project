    ...
    <div className="font-sans ">
      ...
      <div className="flex flex-col ">
        <div className="flex h-10 gap-10">
          <div className="flex flex-col justify-  bg-white w-1/5 h-[7rem] px-4 rounded-md shadow-lg">
        ...
        <div className=" h-20  flex w-full justify-between mt-[8rem]">
          <input
            type="text"
            className="px-2 h-[3rem] w-[10rem] text-mini rounded-md shadow-xl"
            placeholder="Employee Name"
          />
          <div className="px-2 flex flex-col  h-[3rem] w-[10rem] bg-white text-mini rounded-md shadow-xl ">
          ...
          <input
            ...
            placeholder="To"
          />
          <button className="h-[3rem] w-[10rem]  rounded-md shadow-xl  text-lg font-bold bg-[#e6fffa] text-[#13deb9] hover:shadow-green-500 hover:scale-105 transition ease-in-out duration-500  ">
            Search
          </button>
        </div>
        
        <div className="bg-white flex flex-col p-3 rounded-lg shadow-xl  ">
