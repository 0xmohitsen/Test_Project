...
const AdminExitProcess2 = () => {
  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <div className="p-5 border rounded-md bg-white text-[#505050] min-w-[80%] h-[29.5rem] no-scrollbar overflow-scroll">
        <form action="" className="h-fit">
          <div>
                ...
                <div key={item.no} className="w-full mb-3 flex flex-col">
                  ...
                  {item.no >= 4 && item.no <= 8 ? (
                    <StarRating
                      ...
                      onChange={(newRating) =>
                        handleRatingChange(item.no, newRating)
                      }
                    />
                  ) : (
                    <textarea
          ...
          <input
            type="submit"
            value="Submit"
            className="ml-[60rem]  bg-[#e6fffa] mt-5 text-[#13deb9] font-bold  rounded-lg w-[13%] h-10  shadow hover:shadow-green-500 hover:scale-105 transition ease-in-out duration-500 "
          />
        </form>
      </div>
    </div>
...
export default AdminExitProcess2;
